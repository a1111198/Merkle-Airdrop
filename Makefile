...
AIRDROP_ADDRESS := 0x5FC8d32690cc91D4c39d9d3abcBD16989F875707
...
sign :; 
	@cast wallet sign --no-hash --private-key $(DEFAULT_ANVIL_KEY) ${shell cast call ${AIRDROP_ADDRESS} "getMessageDigest(address,uint256)" ${DEFAULT_ANVIL_ADDRESS} ${AIRDROP_AMOUNT} --rpc-url http://localhost:8545}
...
zk-get-message :; cast call ${AIRDROP_ADDRESS} "getMessageDigest(address,uint256)" ${DEFAULT_ANVIL_ADDRESS} ${AIRDROP_AMOUNT} --rpc-url http://127.0.0.1:8011
